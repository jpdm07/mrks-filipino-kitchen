...
const RECIPES = [
  ...
  { id: "flan", title: "Caramel Flan", body: `12 Findful 5oz silver ramekins + clear lids. Bake/serve in same ramekin (one batch = 12).\n\n3×14oz condensed; 2×12oz evaporated; 12 yolks; scaled sugar caramel; 1 tsp vanilla.\n\nCaramel per ramekin, strain custard twice, steam or water bath until set, cool fully, lid on only when cold.` },
