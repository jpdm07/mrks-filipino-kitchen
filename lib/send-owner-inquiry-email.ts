  ...
  <div style="max-width:520px;margin:0 auto;border-radius:12px;overflow:hidden;border:2px solid #FFC200;box-shadow:0 2px 10px rgba(14,29,53,0.12);">
    ...
    <div style="background:#fff;padding:24px 28px;">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-size:15px;">
        ...
        <tr><td style="padding:6px 0;color:#555;">Email</td><td style="padding:6px 0;text-align:right;"><a href="mailto:${encodeURIComponent(params.email)}" style="color:#0e1d35;font-weight:600;">${email}</a></td></tr>
