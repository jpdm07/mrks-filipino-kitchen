/** Customer-facing copy for the ~3–4 day pickup lead time (see ORDER_FULFILLMENT.MIN_LEAD_DAYS). */
export const PICKUP_LEAD_TIME_CUSTOMER_LINE =
  "The next few days aren’t available for pickup online — we need about 3–4 days to prepare your order fresh.";

export const ORDER_FORM_PREP_BANNER =
  "⏱️ Please note: orders need about 3–4 days to prepare. Select your preferred pickup date and time below from our available slots.";
